 ...
 */var dr=Symbol.for("react.element"),hr=Symbol.for("react.portal"),Ke=Symbol.for("react.fragment"),Ge=Symbol.for("react.strict_mode"),Ye=Symbol.for("react.profiler"),qe=Symbol.for("react.provider"),Xe=Symbol.for("react.context"),fl=Symbol.for("react.server_context"),Qe=Symbol.for("react.forward_ref"),Ze=Symbol.for("react.suspense"),Je=Symbol.for("react.suspense_list"),tn=Symbol.for("react.memo"),en=Symbol.for("react.lazy"),dl=Symbol.for("react.offscreen"),Eo;Eo=Symbol.for("react.module.reference");function ot(e){if(typeof e=="object"&&e!==null){var t=e.$$typeof;switch(t){case dr:switch(e=e.type,e){case Ke:case Ye:case Ge:case Ze:case Je:return e;default:switch(e=e&&e.$$typeof,e){case fl:case Xe:case Qe:case en:case tn:case qe:return e;default:return t}}case hr:return t}}}$.ContextConsumer=Xe;$.ContextProvider=qe;$.Element=dr;$.ForwardRef=Qe;$.Fragment=Ke;$.Lazy=en;$.Memo=tn;$.Portal=hr;$.Profiler=Ye;$.StrictMode=Ge;$.Suspense=Ze;$.SuspenseList=Je;$.isAsyncMode=function(){return!1};$.isConcurrentMode=function(){return!1};$.isContextConsumer=function(e){return ot(e)===Xe};$.isContextProvider=function(e){return ot(e)===qe};$.isElement=function(e){return typeof e=="object"&&e!==null&&e.$$typeof===dr};$.isForwardRef=function(e){return ot(e)===Qe};$.isFragment=function(e){return ot(e)===Ke};$.isLazy=function(e){return ot(e)===en};$.isMemo=function(e){return ot(e)===tn};$.isPortal=function(e){return ot(e)===hr};$.isProfiler=function(e){return ot(e)===Ye};$.isStrictMode=function(e){return ot(e)===Ge};$.isSuspense=function(e){return ot(e)===Ze};$.isSuspenseList=function(e){return ot(e)===Je};$.isValidElementType=function(e){return typeof e=="string"||typeof e=="function"||e===Ke||e===Ye||e===Ge||e===Ze||e===Je||e===dl||typeof e=="object"&&e!==null&&(e.$$typeof===en||e.$$typeof===tn||e.$$typeof===qe||e.$$typeof===Xe||e.$$typeof===Qe||e.$$typeof===Eo||e.getModuleId!==void 0)};$.typeOf=ot;Mo.exports=$;var hl=Mo.exports;S`
  from,
  20%,
  53%,
  to {
...
`;function Cl({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:i=pr,iterationCount:r=1}){return za`
  ...
  `}function kl(e){return e==null}function Ml(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}function jo(e,t){return n=>n?e():t()}function te(e){return jo(e,()=>null)}function $n(e){return te(()=>({opacity:0}))(e)}const mr=e=>{const{cascade:t=!1,damping:n=.5,delay:i=0,duration:r=1e3,fraction:s=0,keyframes:o=pr,triggerOnce:a=!1,className:l,style:c,childClassName:u,childStyle:f,children:d,onVisibilityChange:p}=e,m=k.useMemo(()=>Cl({keyframes:o,duration:r}),[r,o]);return kl(d)?null:Ml(d)?G(jl,{...e,animationStyles:m,children:String(d)}):hl.isFragment(d)?G(Ao,{...e,animationStyles:m}):G(rl,{children:k.Children.map(d,(h,v)=>{if(!k.isValidElement(h))return null;const b=i+(t?v*r*n:0);switch(h.type){case"ol":case"ul":return G(mn,{children:({cx:g})=>G(h.type,{...h.props,className:g(l,h.props.className),style:Object.assign({},c,h.props.style),children:G(mr,{...e,children:h.props.children})})});case"li":return G(Yr,{threshold:s,triggerOnce:a,onChange:p,children:({inView:g,ref:y})=>G(mn,{children:({cx:w})=>G(h.type,{...h.props,ref:y,className:w(u,h.props.className),css:te(()=>m)(g),style:Object.assign({},f,h.props.style,$n(!g),{animationDelay:b+"ms"})})})});default:return G(Yr,{threshold:s,triggerOnce:a,onChange:p,children:({inView:g,ref:y})=>G("div",{ref:y,className:l,css:te(()=>m)(g),style:Object.assign({},c,$n(!g),{animationDelay:b+"ms"}),children:G(mn,{children:({cx:w})=>G(h.type,{...h.props,className:w(u,h.props.className),style:Object.assign({},f,h.props.style)})})})})}})})},El={display:"inline-block",whiteSpace:"pre"},jl=e=>{const{animationStyles:t,cascade:n=!1,damping:i=.5,delay:r=0,duration:s=1e3,fraction:o=0,triggerOnce:a=!1,className:l,style:c,children:u,onVisibilityChange:f}=e,{ref:d,inView:p}=ko({triggerOnce:a,threshold:o,onChange:f});return jo(()=>G("div",{ref:d,className:l,style:Object.assign({},c,El),children:u.split("").map((m,h)=>G("span",{css:te(()=>t)(p),style:{animationDelay:r+h*s*i+"ms"},children:m},h))}),()=>G(Ao,{...e,children:u}))(n)},Ao=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:i=!1,className:r,style:s,children:o,onVisibilityChange:a}=e,{ref:l,inView:c}=ko({triggerOnce:i,threshold:n,onChange:a});return G("div",{ref:l,className:r,css:te(()=>t)(c),style:Object.assign({},s,$n(!c)),children:o})};S`
  from,
  20%,
  40%,
  60%,
...
`;function Hl(e,t,n){switch(n){case"bottom-left":return t?Rl:ml;case"bottom-right":return t?Ll:gl;case"down":return e?t?_l:vl:t?Dl:yl;case"left":return e?t?Il:bl:t?Vl:pr;case"right":return e?t?Fl:Sl:t?zl:xl;case"top-left":return t?$l:wl;case"top-right":return t?Bl:Tl;case"up":return e?t?Wl:Ol:t?Nl:Pl;default:return t?Al:pl}}const Ul=e=>{const{big:t=!1,direction:n,reverse:i=!1,...r}=e,s=k.useMemo(()=>Hl(t,i,n),[t,n,i]);return G(mr,{keyframes:s,...r})};S`
  from {
...
`;function tc(e,t){switch(t){case"down":return e?Xl:Kl;case"right":return e?Zl:Yl;case"up":return e?Jl:ql;case"left":default:return e?Ql:Gl}}const ec=e=>{const{direction:t,reverse:n=!1,...i}=e,r=k.useMemo(()=>tc(n,t),[t,n]);return G(mr,{keyframes:r,...i})};S`
  from {
    opacity: 0;
    transform: scale3d(0.3, 0.3, 0.3);
  }
...
`;var Rm={dots:!0,infinite:!0,speed:500,slidesToShow:3,slidesToScroll:1,initialSlide:0,arrows:!1,responsive:[{breakpoint:990,settings:{slidesToShow:2,slidesToScroll:1,infinite:!0,dots:!0}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1,initialSlide:2}},{breakpoint:530,settings:{slidesToShow:1,slidesToScroll:1}}]};const Lm=()=>{const e=k.useRef(null);return x.jsxs(km,{children:[x.jsxs(ec,{direction:"left",children:[x.jsx(Mm,{children:"TESTIMONIALS"}),x.jsx(Em,{children:"WHAT CLIENTS SAY"})]}),x.jsxs(jm,{children:[x.jsx(bm,{ref:e,...Rm,children:Cm.map((t,n)=>x.jsx(Om,{item:t},n))}),x.jsxs(Am,{children:[x.jsx("button",{onClick:()=>e.current.slickPrev(),children:x.jsx(Ha,{})}),x.jsx("button",{onClick:()=>e.current.slickNext(),children:x.jsx(Ua,{})})]})]})]})},Dm="/camp-on-wheels/assets/road-DW9O-MhS.jpg",_m=V.section`
  margin: 4.8rem auto;
  padding: 2.4rem;
  width: 100%;
...
`;var Hm={BASE_URL:"/camp-on-wheels/",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const{VITE_EMAIL_ID:Um,VITE_EMAIL_TEMPLATE_ID:Km,VITE_EMAIL_API_KEY:Gm}=Hm;function Ym(){const e=k.useRef(),t=async n=>{n.preventDefault();const i=n.target.email.value.trim(),r=el.test(i);if(i.length===0){de.warning("Email field cannot be empty. Please enter your email address.",he);return}if(!r){de.warning("The email address you entered is not valid. Please check and try again.",he);return}try{await Ja(i),await tl.sendForm(Um,Km,e.current,{publicKey:Gm}),de.success("Successfully subscribed! We'll keep you updated with regular deals and fresh trip ideas. Thank you!",he),n.target.email.value=""}catch{de.error("Error subscribing. Please try again later.",he)}};return x.jsx(_m,{children:x.jsxs(Vm,{children:[x.jsxs(Im,{children:[x.jsxs(zm,{children:["MORE TRIPS.",x.jsx("br",{})," EXCLUSIVE DEALS."]}),x.jsx(Fm,{children:"Receive fresh trip ideas, curated itineraries, and exclusive deals delivered to your inbox every month."})]}),x.jsxs($m,{ref:e,onSubmit:t,children:[x.jsx(Bm,{type:"text",name:"email",placeholder:"Enter your Email"}),x.jsx(Nm,{type:"submit",children:"Subscribe"})]}),x.jsx(Wm,{})]})})}const qm=V.section`
  margin: 4.8rem auto;
  padding: 2.4rem;
  width: 100%;
...
`;function Xm(){return x.jsxs(qm,{children:[x.jsx(Yt,{src:"images/sponsor2.png",alt:"sponsor1",width:"20rem",height:"20rem",loading:"lazy"}),x.jsx(Yt,{src:"images/sponsor.png",alt:"sponsor2",width:"20rem",height:"20rem",loading:"lazy"}),x.jsx(Yt,{src:"images/sponsor1.png",alt:"sponsor3",width:"20rem",height:"20rem",loading:"lazy"}),x.jsx(Yt,{src:"images/sponsor3.png",alt:"sponsor4",width:"20rem",height:"20rem",loading:"lazy"}),x.jsx(Yt,{src:"images/sponsor4.png",alt:"sponsor5",width:"20rem",height:"20rem",loading:"lazy"})]})}const Qm=V.div`
...
`,o0={initial:{x:0},animate:{x:"-220%",transition:{repeat:1/0,repeatType:"reverse",duration:20}}};function f0(){return x.jsxs(x.Fragment,{children:[x.jsx(Ga,{children:x.jsxs(Ya,{children:[x.jsx("title",{children:"Camp On Wheels - Home Page"}),x.jsx("meta",{name:"description",content:"Unlock boundless journeys with Camp On Wheels. Rent a camping car in style, comfort, and confidence. Explore extraordinary adventures with our premium car rental services."}),x.jsx("meta",{name:"keywords",content:"camping car rental, adventure travel, stylish cars, comfortable journeys, Camp On Wheels, premium rental services"})]})}),x.jsxs(Qm,{children:[x.jsxs(Zm,{children:[x.jsx(er.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:3},children:x.jsxs(Jm,{children:[x.jsxs(t0,{children:["Discover the Freedom of Mobile Exploration with"," ",x.jsx(e0,{children:"Camp On Wheels"})]}),x.jsx(n0,{children:"Embark on unforgettable journeys with CampOnWheels, where every road leads to new adventures. With our fleet of comfortable and fully-equipped camping cars, you can roam wherever your wanderlust takes you, and unwind amidst nature's embrace. Start your journey today and experience the thrill of the open road, without sacrificing the comforts of home."}),x.jsx("div",{style:{textAlign:"end"},children:x.jsx(r0,{to:"catalog",children:"View our Catalog"})})]})}),x.jsx(i0,{children:x.jsx(er.div,{variants:o0,initial:"initial",animate:"animate",children:"Camp On Wheels"})})]}),x.jsx(Oh,{}),x.jsx(Ym,{}),x.jsx(Lm,{}),x.jsx(Xm,{})]})]})}export{f0 as default};
